...
class SignHelper
{
    ...
    private function prepareStringToSign($canonicalURL)
    {
        ...
        $stringToSign .= $this->HMACAlgorithm . PHP_EOL;

        /* Append the request date value, followed by a newline character. */
        $stringToSign .= $this->xAmzDate . PHP_EOL;

        /* Append the credential scope value, followed by a newline character. */
        $stringToSign .= $this->currentDate . '/' . $this->region . '/' . $this->service . '/' . $this->aws4Request . PHP_EOL;
